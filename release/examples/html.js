...
const noString = new Rules.Data.Extract('value', new Rules.Flow.Repeat(new Rules.Flow.Any(new Rules.String.Letters(Parsing.Data.Texts.BOTH), new Rules.String.Digits(), new Rules.Char.Choice('-', '_'))));
