...
const singleString = new Rules.Flow.All(singleQuotes, new Rules.Data.Extract('value', Parsing.Data.Texts.DEFAULT, new Rules.Flow.Repeat(new Rules.Flow.Fork(escapeString, content, new Rules.Flow.Not(singleQuotes, content)))), singleQuotes);
const doubleString = new Rules.Flow.All(doubleQuotes, new Rules.Data.Extract('value', Parsing.Data.Texts.DEFAULT, new Rules.Flow.Repeat(new Rules.Flow.Fork(escapeString, content, new Rules.Flow.Not(doubleQuotes, content)))), doubleQuotes);
const noString = new Rules.Data.Extract('value', Parsing.Data.Texts.DEFAULT, new Rules.Flow.Repeat(new Rules.Flow.Any(new Rules.String.Letters(Parsing.Data.Texts.DEFAULT), new Rules.String.Digits(), new Rules.Char.Choice('-', '_'))));
...
let collection;
let document;
text = new Rules.Status.Success(new Rules.Data.Tree('text', Parsing.Data.Directions.NEXT, new Rules.Data.Extract('content', Parsing.Data.Texts.DEFAULT, new Rules.Flow.Repeat(new Rules.Flow.Not(tagOpen, content)))));
comment = new Rules.Status.Success(new Rules.Flow.All(commentOpen, new Rules.Data.Tree('comment', Parsing.Data.Directions.NEXT, new Rules.Data.Extract('content', Parsing.Data.Texts.DEFAULT, new Rules.Flow.Repeat(new Rules.Flow.Not(commentClose, content)))), commentClose));
parameters = new Rules.Data.Tree('attribute', Parsing.Data.Directions.NEXT, new Rules.Flow.All(new Rules.Data.Extract('name', Parsing.Data.Texts.LOWERCASE, paramName), optionalSpace, new Rules.Flow.Option(new Rules.Flow.All(paramAssign, optionalSpace, new Rules.Flow.Any(singleString, doubleString, noString)))));
element = new Rules.Status.Success(new Rules.Data.Tree('element', Parsing.Data.Directions.NEXT, new Rules.Flow.All(new Rules.Status.Error(Errors.EXPECTED_TAG_OPENING, tagOpen), optionalSpace, new Rules.Status.Error(Errors.EXPECTED_TAG_NAME, new Rules.Data.Extract('name', Parsing.Data.Texts.LOWERCASE, tagName)), optionalSpace, new Rules.Flow.Option(new Rules.Data.Node(Parsing.Data.Directions.NEXT, Parsing.Data.Directions.LEFT, new Rules.Flow.Repeat(new Rules.Flow.All(parameters, optionalSpace)))), new Rules.Flow.Any(new Rules.Data.Condition('name', Parsing.Data.Conditions.INCLUDES, ['area', 'base', 'br', 'col', 'embed', 'hr', 'img', 'input', 'link', 'meta', 'param', 'source', 'track', 'wbr'], new Rules.Status.Error(Errors.EXPECTED_TAG_CLOSING, tagClose)), new Rules.Flow.All(new Rules.Status.Error(Errors.EXPECTED_TAG_ENDING, tagEnding), optionalSpace, new Rules.Status.Error(Errors.EXPECTED_TAG_CLOSING, tagClose)), new Rules.Flow.All(new Rules.Status.Error(Errors.EXPECTED_TAG_CLOSING, tagClose), optionalSpace, new Rules.Data.Node(Parsing.Data.Directions.NEXT, Parsing.Data.Directions.RIGHT, new Rules.Flow.Option(new Rules.Flow.Reference(() => collection))), new Rules.Status.Error(Errors.EXPECTED_TAG_OPENING, tagOpen), optionalSpace, new Rules.Flow.All(new Rules.Status.Error(Errors.EXPECTED_TAG_ENDING, tagEnding), optionalSpace), new Rules.Status.Error(Errors.EXPECTED_TAG_CLOSE, new Rules.Data.Match('name', Parsing.Data.Texts.LOWERCASE, tagName)), optionalSpace, new Rules.Status.Error(Errors.EXPECTED_TAG_CLOSING, tagClose))))));
