...
const singleString = new Parsing.Rules.All(singleQuotes, new Parsing.Rules.Data.Extract('value', new Parsing.Rules.Repeat(new Parsing.Rules.Fork(escapeString, content, new Parsing.Rules.Not(singleQuotes, content)))), singleQuotes);
const doubleString = new Parsing.Rules.All(doubleQuotes, new Parsing.Rules.Data.Extract('value', new Parsing.Rules.Repeat(new Parsing.Rules.Fork(escapeString, content, new Parsing.Rules.Not(doubleQuotes, content)))), doubleQuotes);
